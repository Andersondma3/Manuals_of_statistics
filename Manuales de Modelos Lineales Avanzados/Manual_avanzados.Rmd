...
Podemos mejorar los intervalos, debido a que la función `emmeans`, toma en cuenta todas las diferencias posibles. Sin emabargo no todas las diferencias son significativas, por lo que se necesita aplicar el siguiente proceso para mejor su precisión.

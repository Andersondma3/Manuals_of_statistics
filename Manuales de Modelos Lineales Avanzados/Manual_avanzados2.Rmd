...
```{r, echo=FALSE, message=FALSE, fig.width=6.5, fig.height=3.5, fig.align='center'}
library(ggplot2)
library(dplyr)
...
Observe que en este caso, en la mayoría hay linealiad, en algunos hay otros comportamuientos, pero los mismos no son consistentes. Además con solo cuatro puntos no podemos asegurar ningún otro tipo de comportamiento, por lo que asumimos que se cumple el supuesto de linealidad.
...
3. $H_0: \sigma_{\delta}:$ Hay que tener cuidado, porque **depende del sieño este no se puede eliminar**

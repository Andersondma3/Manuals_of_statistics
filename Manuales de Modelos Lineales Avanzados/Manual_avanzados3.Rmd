...
La clave de este modelo es el `offset = log(meses_exposicion)`, ya que aquí le decimos que loa agregue, pero que no le calcule un coeficiente.
...
**Si no fuera con la Tasa:** También El número promedio de transacciones de los clientes de la tarjeta Gold es 51% mayor en comparación con la cantidad de los clientes de la tarjeta Regular.

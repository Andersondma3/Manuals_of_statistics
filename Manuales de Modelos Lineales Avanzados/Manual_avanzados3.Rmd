...
# 1. Obtenemos ÚNICAMENTE las medias estimadas de las dosis
em_dosis <- emmeans(mod.trat, ~ dosix)

# 2. Calculamos los contrastes inversos (revpairwise) de una sola cola con Bonferroni
# Nota: 'revpairwise' en pairs() se especifica con reverse = TRUE
contrastes_unilaterales <- pairs(em_dosis, reverse = TRUE, side = "<", adjust = "bonferroni")

# 3. Obtenemos el intervalo de confianza en la escala original (response)
confint(contrastes_unilaterales, type = "response")
```
